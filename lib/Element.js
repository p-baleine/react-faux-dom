...
Element.prototype.toReact = function (index) {
  ...
  return React.createElement(this.nodeName, props, this.text || (!this.children ? null : this.children.map(function (el, i) {
    if (el instanceof Element) {
      return el.toReact(i)
    } else {
      return el
...
Object.defineProperties(Element.prototype, {
  ...
  children: {
    get: function () {
      if (htmlVoidElements.indexOf(this.nodeName) !== -1) {
        return null;
      }
